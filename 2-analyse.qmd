...
coords2 <- stations_data |>
  ...
  unlist(use.names = FALSE)   # pour tranformer en vecteur
...
::::{.callout-tip}
1. Les noms des principaux aéroports de métropole contiennent le nom de la ville qu'il dessert. 
